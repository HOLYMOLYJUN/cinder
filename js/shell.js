/* =========================================================
   ...
   특히 모닥불과 결말은 **닫는 키가 없는 것이 의도**다 — 불 앞에서 아무것도
   안 하고 지나갈 수 있으면 그건 선택이 아니라 무시해도 되는 창이 된다.
   그래서 뒤로가기도 거기서는 아무 일도 하지 않는다.
   ========================================================= */
...
const Shell = {
  ...
  back() {
    ...
    // 모닥불과 결말은 닫는 길이 없는 것이 의도다. 삼켜 버린다.
    if (UI.campOpen() || UI.endingOpen()) return false;
